    ...
    while (i < j) {
      ...
      if (onLifecycleEvent != null) {
        ...
        if (arrayOfClass.length > 0) {
          if (arrayOfClass[0].isAssignableFrom(LifecycleOwner.class)) {
            b = 1;
          } else {
  ...
  static class MethodReference {
    ...
    public boolean equals(Object param1Object) {
      ...
      if (this == param1Object)
        return true; 
      if (param1Object == null || MethodReference.class != param1Object.getClass())
        return false; 
...
/* Location:              /home/andrelcol/Desktop/securityDebt/onstar/meuProjeto.jar!/androidx/lifecycle/ClassesInfoCache.class
