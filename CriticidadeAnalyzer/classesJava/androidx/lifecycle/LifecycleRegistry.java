...
public class LifecycleRegistry extends Lifecycle {
  ...
  public void addObserver(LifecycleObserver paramLifecycleObserver) {
    ...
    Lifecycle.State state1 = Lifecycle.State.DESTROYED;
    if (state2 != state1)
      state1 = Lifecycle.State.INITIALIZED; 
    ObserverWithState observerWithState = new ObserverWithState(paramLifecycleObserver, state1);
    ...
    state1 = calculateTargetState(paramLifecycleObserver);
    this.mAddingObserverCounter++;
    while (observerWithState.mState.compareTo(state1) < 0 && this.mObserverMap.contains(paramLifecycleObserver)) {
      pushParentState(observerWithState.mState);
...
/* Location:              /home/andrelcol/Desktop/securityDebt/onstar/meuProjeto.jar!/androidx/lifecycle/LifecycleRegistry.class
