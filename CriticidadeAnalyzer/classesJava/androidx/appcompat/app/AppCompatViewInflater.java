...
public class AppCompatViewInflater {
  ...
  private static Context themifyContext(Context paramContext, AttributeSet paramAttributeSet, boolean paramBoolean1, boolean paramBoolean2) {
    ...
    if (paramBoolean1) {
      b = typedArray.getResourceId(R.styleable.View_android_theme, 0);
    } else {
      b = 0;
    } 
    int i = b;
    ...
    if (i != 0) {
      if (paramContext instanceof ContextThemeWrapper) {
        ...
        return (Context)((((ContextThemeWrapper)paramContext).getThemeResId() != i) ? new ContextThemeWrapper(paramContext, i) : context);
      } 
    } else {
      return context;
    } 
  ...
  final View createView(View paramView, String paramString, Context paramContext, AttributeSet paramAttributeSet, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4) {
    ...
    //   478: aload #10
    //   480: aload #4
    //   482: invokevirtual createSeekBar : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSeekBar;
    //   485: astore_1
    //   486: aload_0
    //   487: aload_1
    //   488: aload_2
    ...
    //   496: aload #10
    //   498: aload #4
    //   500: invokevirtual createRatingBar : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRatingBar;
    //   503: astore_1
    //   504: aload_0
    //   505: aload_1
    //   506: aload_2
    ...
    //   514: aload #10
    //   516: aload #4
    //   518: invokevirtual createMultiAutoCompleteTextView : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatMultiAutoCompleteTextView;
    //   521: astore_1
    //   522: aload_0
    //   523: aload_1
    //   524: aload_2
    ...
    //   532: aload #10
    //   534: aload #4
    //   536: invokevirtual createAutoCompleteTextView : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    //   539: astore_1
    //   540: aload_0
    //   541: aload_1
    //   542: aload_2
    ...
    //   550: aload #10
    //   552: aload #4
    //   554: invokevirtual createCheckedTextView : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckedTextView;
    //   557: astore_1
    //   558: aload_0
    //   559: aload_1
    //   560: aload_2
    ...
    //   568: aload #10
    //   570: aload #4
    //   572: invokevirtual createRadioButton : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    //   575: astore_1
    //   576: aload_0
    //   577: aload_1
    //   578: aload_2
    ...
    //   586: aload #10
    //   588: aload #4
    //   590: invokevirtual createCheckBox : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    //   593: astore_1
    //   594: aload_0
    //   595: aload_1
    //   596: aload_2
    ...
    //   604: aload #10
    //   606: aload #4
    //   608: invokevirtual createImageButton : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageButton;
    //   611: astore_1
    //   612: aload_0
    //   613: aload_1
    //   614: aload_2
    ...
    //   622: aload #10
    //   624: aload #4
    //   626: invokevirtual createSpinner : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSpinner;
    //   629: astore_1
    //   630: aload_0
    //   631: aload_1
    //   632: aload_2
    ...
    //   640: aload #10
    //   642: aload #4
    //   644: invokevirtual createEditText : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatEditText;
    //   647: astore_1
    //   648: aload_0
    //   649: aload_1
    //   650: aload_2
    ...
    //   658: aload #10
    //   660: aload #4
    //   662: invokevirtual createButton : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;
    //   665: astore_1
    //   666: aload_0
    //   667: aload_1
    //   668: aload_2
    ...
    //   676: aload #10
    //   678: aload #4
    //   680: invokevirtual createImageView : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    //   683: astore_1
    //   684: aload_0
    //   685: aload_1
    //   686: aload_2
    ...
    //   694: aload #10
    //   696: aload #4
    //   698: invokevirtual createTextView : (Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    //   701: astore_1
    //   702: aload_0
    //   703: aload_1
    //   704: aload_2
...
/* Location:              /home/andrelcol/Desktop/securityDebt/onstar/meuProjeto.jar!/androidx/appcompat/app/AppCompatViewInflater.class
