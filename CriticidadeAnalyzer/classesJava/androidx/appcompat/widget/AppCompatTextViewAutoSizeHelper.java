...
class AppCompatTextViewAutoSizeHelper {
  ...
  private StaticLayout createStaticLayoutForMeasuringPre23(CharSequence paramCharSequence, Layout.Alignment paramAlignment, int paramInt) {
    ...
    if (Build.VERSION.SDK_INT >= 16) {
      ...
      f1 = this.mTextView.getLineSpacingExtra();
      ...
      f1 = ((Float)invokeAndReturnWithDefault(this.mTextView, "getLineSpacingExtra", Float.valueOf(0.0F))).floatValue();
...
/* Location:              /home/andrelcol/Desktop/securityDebt/onstar/meuProjeto.jar!/androidx/appcompat/widget/AppCompatTextViewAutoSizeHelper.class
