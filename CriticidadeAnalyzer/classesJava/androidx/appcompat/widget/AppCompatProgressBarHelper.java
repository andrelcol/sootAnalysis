...
class AppCompatProgressBarHelper {
  ...
  private Drawable tileify(Drawable paramDrawable, boolean paramBoolean) {
    ...
    if (paramDrawable instanceof WrappedDrawable) {
      ...
      if (drawable2 != null) {
        wrappedDrawable.setWrappedDrawable(tileify(drawable2, paramBoolean));
...
/* Location:              /home/andrelcol/Desktop/securityDebt/onstar/meuProjeto.jar!/androidx/appcompat/widget/AppCompatProgressBarHelper.class
