...
class WrappedDrawableApi14 extends Drawable implements Drawable.Callback, WrappedDrawable, TintAwareDrawable {
  ...
  private void updateLocalState(Resources paramResources) {
    ...
    if (drawableWrapperState != null) {
      ...
      if (constantState != null)
        setWrappedDrawable(constantState.newDrawable(paramResources)); 
    } 
  }
  ...
  public boolean isStateful() {
    ...
    //   4: ifeq -> 24
    //   7: aload_0
    //   8: getfield mState : Landroidx/core/graphics/drawable/WrappedDrawableApi14$DrawableWrapperState;
    //   11: astore_2
    //   12: aload_2
    //   13: ifnull -> 24
    //   16: aload_2
...
/* Location:              /home/andrelcol/Desktop/securityDebt/onstar/meuProjeto.jar!/androidx/core/graphics/drawable/WrappedDrawableApi14.class
