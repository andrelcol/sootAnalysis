...
public class FontResourcesParserCompat {
  ...
  private static FamilyResourceEntry readFamily(XmlPullParser paramXmlPullParser, Resources paramResources) throws XmlPullParserException, IOException {
    ...
    String str2 = typedArray.getString(R.styleable.FontFamily_fontProviderAuthority);
    String str3 = typedArray.getString(R.styleable.FontFamily_fontProviderPackage);
    String str1 = typedArray.getString(R.styleable.FontFamily_fontProviderQuery);
    ...
    if (str2 != null && str3 != null && str1 != null) {
      while (paramXmlPullParser.next() != 3)
        skip(paramXmlPullParser); 
      return new ProviderResourceEntry(new FontRequest(str2, str3, str1, readCerts(paramResources, k)), j, i);
    } 
...
/* Location:              /home/andrelcol/Desktop/securityDebt/onstar/meuProjeto.jar!/androidx/core/content/res/FontResourcesParserCompat.class
