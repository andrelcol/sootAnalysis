...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent2, NestedScrollingChild2, ScrollingView {
  ...
  public boolean pageScroll(int paramInt) {
    ...
    int i = rect.top;
    rect.bottom = j + i;
    return scrollAndFocus(paramInt, i, rect.bottom);
  }
  ...
  public void scrollTo(int paramInt1, int paramInt2) {
    if (getChildCount() > 0) {
      ...
      paramInt1 = clamp(paramInt1, i3 - i6 - i5, i7 + i4 + i2);
      paramInt2 = clamp(paramInt2, i - j - i1, k + m + n);
  ...
  public final void smoothScrollBy(int paramInt1, int paramInt2) {
    ...
    if (AnimationUtils.currentAnimationTimeMillis() - this.mLastScroll > 250L) {
      ...
      int k = getPaddingBottom();
      paramInt1 = getScrollY();
      paramInt2 = Math.max(0, Math.min(paramInt2 + paramInt1, Math.max(0, n + i1 + m - i - j - k)));
      this.mLastScrollerY = getScrollY();
  ...
  static class AccessibilityDelegate extends AccessibilityDelegateCompat {
    ...
    public boolean performAccessibilityAction(View param1View, int param1Int, Bundle param1Bundle) {
      ...
      if (param1Int != 4096) {
        ...
        param1Int = Math.max(nestedScrollView.getScrollY() - param1Int - m - k, 0);
      ...
      param1Int = Math.min(nestedScrollView.getScrollY() + j - param1Int - i, nestedScrollView.getScrollRange());
      if (param1Int != nestedScrollView.getScrollY()) {
        nestedScrollView.smoothScrollTo(0, param1Int);
        return true;
      } 
...
/* Location:              /home/andrelcol/Desktop/securityDebt/onstar/meuProjeto.jar!/androidx/core/widget/NestedScrollView.class
